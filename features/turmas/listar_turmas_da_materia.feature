...
Funcionalidade: Listar turmas da materia
  ...
  Delineação do Cenário: Disciplina com turmas
    ...
    Então eu devo ver uma lista contendo as turmas "<name>", "<schedule>", "<professor>"
  ...
  Cenário: Disciplina sem turmas
    ...
    E que eu tenha uma matéria criada com os atributos:
      ...
      |area   |AC                     |
    E que eu esteja na página dessa matéria
    Então eu devo ver uma lista vazia de turmas
